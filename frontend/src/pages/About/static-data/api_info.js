...
const APIInfo = [
  {
    ...
    desc: "Synthesizes information to provide the richest and most accurate context about over 4.3+ million destinations. Scraped into a database using Python script.",
  },
  {
    image: Maps,
    link: "https://developers.google.com/maps",
    name: "Google Maps API",
    desc: "Integrates Google's Place details, search, and autocomplete into apps. Scraped into a database using Python script.",
  },
  {
    image: RapidAPI,
    link: "https://rapidapi.com/Active-api/api/airport-info/",
    name: "Airport Info API",
    desc: "Extensive database of airport codes and data, including address, phone number, website and more. Scraped into a database using Python script.",
  },
  {
    image: NatParkService,
    link: "https://www.nps.gov/subjects/developer/api-documentation.htm",
    name: "National Park Service",
    desc: "Provides authoritative National Park Service (NPS) data and content about parks and their facilities, events, news, alerts, and more. Scraped into a database using Python script.",
  },
  {
    image: GitLab,
