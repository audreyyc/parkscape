...
function AboutPage() {
  ...
  async function get_commits() {
    ...
    var url = 'https://gitlab.com/api/v4/projects/43345825/repository/contributors/';
  ...
  async function get_issues() {
    DeveloperInfo.forEach((user) => {
      var request = new XMLHttpRequest();
      var url = 'https://gitlab.com/api/v4/projects/43345825/issues_statistics?author_id='.concat(user.user_id);
      request.open('GET', url);
      request.onload = function() {
          var result = JSON.parse(this.response);
  ...
  async function total_commits() {
    var request = new XMLHttpRequest();
    var url = 'https://gitlab.com/api/v4/projects/43345825/repository/commits/?per_page=1000';
    request.open('GET', url);
    request.onload = function() {
        var result = JSON.parse(this.response);
